...
model = Sequential()
model.add(Conv2D(filters= 1, kernel_size= (5,1), activation='relu', input_shape=(180, 1, 1)))
...
model.save('cnn_torres_vert.h5')
import joblib

#filename = '/home/mathias/catkin_ws/src/lidar_samples_reloaded/src/cnn/modelSave/model_torres_horiz.sav'
filenameSC = '/home/mathias/catkin_ws/src/lidar_samples_reloaded/src/cnn/sc_torres_vert.sav'
